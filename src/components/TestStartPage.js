...
const TestStartPage = () => {
  ...
  const [select, setSelect] = useState(Array(12).fill(0));
  ...
  const setResult = () => {
    ...
    const resultImg = <img src={imgURL} alt={point} className="img-fluid" />;
  ...
  const renderQuestion = () => {
    ...
    return (
      <div className="questionContainer">
        ...
        <div className="answerContainer">{renderAnswers(qIdx)}</div>
      </div>
    );
  };
  ...
  return (
    <div className="App">
      ...
      <div id="result" className="fadeOut">
        <h3 className="resultname"></h3>
        <div id="resultImg" className="imgContainer"></div>
